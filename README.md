...
| [`html-artifact`](skills/html-artifact/SKILL.md) | Produce single-file interactive HTML artifacts instead of markdown prose — autonomously, without being asked — using Tailwind + DaisyUI + Alpine.js. |
...
| [`mockup`](skills/mockup/SKILL.md) | Generate high-fidelity, contextually-rich single-file HTML mockups — one polished take, or a panel of distinct "design team" takes on the same content for picking a direction. |
